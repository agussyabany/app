...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <h1 class="m-0 text-center">DATA SUMBER DAYA MANUSIA</h1>
  </div>
  <!-- /.content-header -->
  <div class="content">
    <div class="float-right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-sdm" id="tambah_sdm">Tambah Data SDM</button>
    </div>
  <br><br>

...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <h1 class="m-0 text-center">DATA OPERASIONAL</h1>
  </div>
  <!-- /.content-header -->
  <div class="content">
    <div class="float-right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-operasional" id="tambah_operasional">Tambah Data Operasional</button>
    </div>
  <br><br>
      ...
      <div class="modal fade" id="modal-operasional">

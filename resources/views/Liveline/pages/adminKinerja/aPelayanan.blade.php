...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <h1 class="m-0 text-center">DATA PELAYANAN</h1>
  </div>
  <!-- /.content-header -->
  <div class="content">
    <div class="float-right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-pelayanan" id="tambah_pelayanan">Tambah Data Pelayanan</button>
    </div>
  <br><br>
                                <table class="table table-striped responsive" id="tbl">
                                    <thead>
                                        <tr>
                                            <th>NO</th>
                                            <th class="text-wrap" style="width: 200px;">Jumlah Penduduk Terlayani</th>
                                            <th class="text-wrap" style="width: 200px;">Jumlah penduduk wilayah pelayanan</th>
                                            <th class="text-wrap" style="width: 200px;">Pengaduan Selesai Ditangani</th>
                                            <th class="text-wrap" style="width: 200px;">Jumlah Pengaduan</th>
                                            <th class="text-wrap" style="width: 200px;">Jml air yg terjual pada plgn.domestik</th>
                                            <th>Jumlah Pelanggan Domestik</th>
                                            <th class="text-wrap" style="width: 200px;">Jml Uji Kualitas Yg Memenuhi Syarat</th>
                                            <th>Jumlah Titik yg Diuji atau Titik Minimal</th>
                                            <th>Jumlah Pelanggan Tahun ini - Jumlah Pelanggan Tahun Lalu</th>
                                            <th>Jumlah Pelanggan Tahun Lalu</th>
                                            <th>Bulan Tahun</th>
                                            <th></th>
                                        </tr>
                                    </thead>
      ...
      <div class="modal fade" id="modal-pelayanan">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"  id="judul_pelayanan">Input Data Operasional</h4>
